...
# =============================================================================
# This Flask application has been disabled to convert the website to a static
# frontend-only site for deployment to Netlify/Vercel.
#
# REASON FOR DISABLING:
# - The website is being refactored to be a static site (HTML/CSS/JS only)
# - No Python backend is needed for static hosting
# - Form handling is now done via Netlify Forms or Formspree
#
...
# - Analytics tracking (page views, form submissions)
# - Airtable integration for feedback forms
# - Dynamic content management
# - API endpoints for form processing
# =============================================================================

# COMMENTED OUT - Flask backend disabled for static deployment
# from flask import Flask, render_template, redirect, url_for, request, flash, jsonify
# import os
# import logging
# from enhanced_features import analytics, form_processor, content_manager, utilities

# COMMENTED OUT - Backend disabled for static deployment
...
# COMMENTED OUT - All Flask routes and functionality disabled for static deployment
# # Routes
# @app.route('/')
# def home():
...
# =============================================================================
# The Flask application has been completely disabled for static deployment.
# All routes, API endpoints, and server functionality are now commented out.
# 
# For static deployment, the website now uses:
# - Static HTML files instead of Flask templates
# - Netlify Forms or Formspree for form handling
