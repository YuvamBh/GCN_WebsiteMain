...
def add_test_data():
    ...
    for event in sample_events:
        content_manager.add_event(event)
    ...
    sample_stories = [
        {
            ...
            "company": "Google",
            "story": "GCN helped me secure my dream job through networking events and career workshops."
        },
        {
            "name": "Michael Chen",
            "position": "Data Analyst",
            "company": "Amazon",
            "story": "The mentorship program at GCN connected me with industry professionals."
        }
    ]
    
    for story in sample_stories:
        content_manager.add_success_story(story)
    
    logger.info("Test data added successfully")

if __name__ == "__main__":
    # Add test data when running directly
    add_test_data()
    print("GCN Enhanced Features initialized successfully!")
    print(f"Analytics Summary: {get_website_stats()}") 